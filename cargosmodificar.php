<?php 
    ...
    $id = trim($_GET['id']);
    $qry = "select * from cargos where id=$id";
    //echo $qry."<br>";
...
<html lang="en">
    ...
    <form action="metodos.php?metodo=cargosmodificar" method="POST" onsubmit="return valida_campos()">
        <table class="styled-table-1">
            <thead>
                <tr>
                    <th colspan="2">MODIFICAR DATOS DEL CARGO</th>
                </tr>
            </thead>
            <tbody>
                <tr>
        ...
        <table class="tablabotones">
            <tr>
                ...
                <td><input type="button" name="cancelar" id="cancelar" class = "boton" value="CANCELAR" title="CANCELAR"  onclick="javascript:{lanzar('cargosvista.php')}"></td>
            </tr>
        </table>
    </form>
</html>