...
<html lang="en">
    ...
    <table class="tablabotones">
        <tr>
            <td><input type="button"  class="boton boton-azul" value="AGREGAR" title="AGREGAR ARTICULO" onclick="javascript:{lanzar('articulosagregar.php')}"></td>
        ...
        <tbody>
                ...
                ?>	
                        <tr class="<?php echo $color[$ncolor]?>">
                            ...
                            <td><input type="button"  class="boton boton-amarillo" title="MODIFICAR ARTICULO" value="MODIFICAR" onclick="javascript:{lanzar('articulosmodificar.php?id=<?php echo $id?>')}" /></td>
                        </tr> 
                <?php
                        $i++;
                        $ncolor = $ncolor + 1;
