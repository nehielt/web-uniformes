...
<html lang="en">
    ...
    <form action="metodos.php?metodo=tallasguardar" method="POST" onsubmit="return valida_campos()">
        <table class="styled-table-1">
            <thead>
                <tr>
                    <th colspan="2">AGREGAR TALLA</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>DESCRIPCION:</td>
                    <td><input type="text" id="descripcion" name="descripcion" size="5" maxlength="5" autofocus oninput="convertirDescripcionAMayusculas()" style="text-transform: uppercase;"></td>
                </tr>
            </tbody>
        </table>
