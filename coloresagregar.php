...
<html lang="en">
    ...
    <form action="metodos.php?metodo=coloresguardar" method="POST" onsubmit="return valida_campos()">
        <table class="styled-table-1">
            <thead>
                <tr>
                    <th colspan="2">AGREGAR COLOR</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>DESCRIPCION:</td>
                    <td><input type="text" id="descripcion" name="descripcion" size="30" maxlength="30" autofocus oninput="convertirDescripcionAMayusculas()" style="text-transform: uppercase;"></td>
                </tr>
            </tbody>
        </table>
