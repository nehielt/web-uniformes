<?php 
    ...
    $id = trim($_GET['id']);
    $qry = "select * from ubicaciones where id=$id";
    //echo $qry."<br>";
...
<html lang="en">
    ...
    <form action="metodos.php?metodo=ubicacionesmodificar" method="POST" onsubmit="return valida_campos()">
        <table class="styled-table-1">
            <thead>
                <tr>
                    <th colspan="2">MODIFICAR DATOS DE LA UBICACION</th>
                </tr>
            </thead>
            <tbody>
                <tr>
        ...
        <table class="tablabotones">
            <tr>
                ...
                <td><input type="button" name="cancelar" id="cancelar" class = "boton" value="CANCELAR" title="CANCELAR"  onclick="javascript:{lanzar('ubicacionesvista.php')}"></td>
            </tr>
        </table>
    </form>
</html>