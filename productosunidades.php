...
<html lang="en">
    ...
    <form action="metodos.php?metodo=productosunidadesmodificar" method="POST" >
        <table class="styled-table-1">
            <thead>
                <tr>
                    <th colspan="2">ACTUALIZAR UNIDADES DEL PRODUCTO</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    <td>UNIDADES ACTUALES:</td>
                    <td><input type="text" id="unidades" name="unidades" size="10" maxlength="10" onKeyPress='return sincoma(event)' ></td>
                </tr>
            </tbody>
        </table>
